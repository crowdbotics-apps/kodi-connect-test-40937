"""
Django settings for kodi_connect_test_40937 project.
...
ROOT_URLCONF = 'kodi_connect_test_40937.urls'
...
WSGI_APPLICATION = 'kodi_connect_test_40937.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kodi_connect_test_40937 API",
    "DESCRIPTION": "API documentation for kodi_connect_test_40937 App",
    "VERSION": "v1",
}
